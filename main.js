const DATA = {
  ...
  STACK: [
    ...
    { icon: "⚛️", name: "React.js", type: "Frontend", color: "#61dafb" },
    { icon: "🔷", name: "TypeScript", type: "Frontend", color: "#3178C6" },
    { icon: "⚙️", name: "Git", type: "DevOps", color: "#f05032" },
  ],

  SKILLS: [
    { icon: "🏭", name: "ERP Development" },
    { icon: "👥", name: "HRM Systems" },
    { icon: "💰", name: "Accounting Systems" },
    { icon: "🔄", name: "Workflow Automation" },
    { icon: "📡", name: "System Integration" },
    { icon: "🤖", name: "AI-Assisted Development" },
  ...
  SERVICES: [
    {
      ...
      desc: "Customized ERP systems to streamline processes and deliver real-time operational insights.",
    },
    {
      num: "02",
      icon: "💻",
      name: "Web Development",
      desc: "Responsive, high-performance apps with Laravel, Vue.js, Inertia.js, and Vite.",
    },
    {
      num: "03",
      icon: "🎨",
      name: "Web Design",
      desc: "User-focused interfaces built with Tailwind CSS, aligned with business goals and UX best practices.",
    },
    {
      num: "04",
      icon: "🚀",
      name: "Tech Growth",
      desc: "Constantly learning — AJAX, REST APIs, performance tuning — staying at the frontier of the web.",
    },
  ],
  ...
  PROJECTS: [
    {
      ...
      year: "2026",
      featured: true,
      desc: "Enterprise management system for YKK covering General Affairs and Legal operations. Played a key role in developing multiple business-critical modules including Vehicle Management, Overseas Visa Management, Bangladesh Visa Management, Air Ticket Management, Apartment Management, Hotel Management, Office Administration, dashboards, reporting, and workflow automation.",
      tech: ["Laravel", "JavaScript", "MySQL", "React.js", "Tailwind CSS", "TypeScript", "Vite"],
      demo: "",
      repo: "",
    },
    {
      icon: "💳",
      name: "MOMO EMI Platform",
      category: "FinTech",
      status: "Live",
      year: "2026",
      featured: true,
      desc: "A Mobile Money-based EMI platform enabling customers to purchase mobile devices through cardless installment facilities. Contributed to Product EMI Configuration, Offer Management, business rule implementation, and backend workflows supporting flexible financing options.",
      tech: ["Laravel", "MySQL", "JavaScript", "Vue.js", "REST API"],
      demo: "",
      repo: "",
    },
    {
    ...
    },
    {
      ...
      tech: ["Laravel", "JavaScript", "MySQL", "AJAX", "Bootstrap"],
      demo: "",
      repo: "",
    },
    {
  ...
  BIO: {
    short_bio:
      "Dedicated software engineer based in Dhaka, creating dynamic and user-friendly applications that drive innovation.",
    long_bio:
      "I'm Md. Al Amin, a software engineer at Ambala IT. I specialize in Laravel, JavaScript, and MySQL, delivering efficient and user-focused web applications.",
  },
  ...
  EDUCATION: [
    {
      ...
      type: "Education",
      description:
        "BSc (Professional) affiliated with National University — focused on software engineering, databases, and web technologies.",
    },
    {
      ...
      type: "Training",
      description:
        "Comprehensive training in modern web design and development with hands-on projects.",
    },
    {
  ...
  EXPERIENCE: [
    {
      ...
      company: "Ambala IT",
      responsibilities: [
        "Developed and maintained ERP applications focused on Accounting and Human Resource Management (HRM) modules, including financial workflows, reporting, payroll, and employee management.",
        "Customized enterprise software solutions to meet client-specific business requirements and improve operational efficiency.",
        "Played a key role in the development and maintenance of the YKK GA & Legal System.",
        "Developed and supported attendance device integration solutions to streamline attendance management and reduce manual processing.",
        "Delivered ongoing enhancements, bug fixes, and technical support for existing applications, ensuring system stability and continuous improvement.",
        "Collaborated with cross-functional teams throughout the software development lifecycle, from requirements analysis to deployment and support.",
      ],
    },
    {
      ...
      responsibilities: [
        "Developed and maintained web applications using Laravel and PHP, delivering scalable and user-focused solutions.",
        "Built interactive and responsive user interfaces using JavaScript, React.js, AJAX, HTML, and CSS.",
        "Collaborated with cross-functional teams throughout the software development lifecycle, from requirements gathering to deployment.",
        "Designed, optimized, and maintained MySQL databases to ensure data integrity and application performance.",
        "Performed application maintenance, bug fixing, feature enhancements, and performance optimization.",
        "Utilized Git for version control, code management, and effective team collaboration.",
      ],
    },
    {
      ...
      responsibilities: [
        "Provided technical support for ISP infrastructure, routers, and switches to end-users based on requirements.",
        "Coordinated with the network operation team to ensure smooth rollout plans and service delivery.",
      ],
    },
  ],
};
...
function buildSidebar() {
  ...
  /* ── Name / Role / Bio ── */
  const name = createElement("div", "sb-name");
  name.textContent = DATA.NAME;
  const role = createElement("div", "sb-role");
  role.textContent = DATA.ROLE;
  const bio = createElement("div", "sb-bio");
  bio.textContent = DATA.BIO.short_bio;
  sb.appendChild(name);
  sb.appendChild(role);
  sb.appendChild(bio);
  ...
  const ttThumb = createElement("div", "tt-thumb");
  ttThumb.id = "ttThumb";
  ttThumb.textContent = "☀️";
  const ttLbl = createElement("span", "tt-lbl");
  ttLbl.id = "ttLbl";
  ttLbl.textContent = "Dark";
...
function buildAbout() {
  ...
  sec.innerHTML = `
    ...
    <div class="bento">
      ...
      <!-- Hero -->
      <div class="bc c7">
        <div class="hero-eye">// ${DATA.ROLE} · ${DATA.STACK.slice(0, 3)
          .map((s) => s.name)
          .join(" · ")}</div>
...
function buildResume() {
  ...
  const eduHTML = DATA.EDUCATION.map(
    (e) => `
    <div class="tli">
  ...
  const skillsHTML = DATA.SKILLS.map(
    (s) => `
    <div class="sp">
...
function buildSnapshot() {
  ...
  const statusStyle = {
    ...
    "In Progress": {
      bg: "rgba(124,110,247,.1)",
      border: "rgba(124,110,247,.28)",
      color: "var(--accent)",
    },
  };
  ...
  const cardsHTML = DATA.PROJECTS.map((p, i) => {
    ...
    const demoBtn = p.demo
      ? `<a class="plink plink-demo" href="${p.demo}" target="_blank">↗ Live Demo</a>`
      : "";
    const repoBtn = p.repo
      ? `<a class="plink plink-repo" href="${p.repo}" target="_blank">🐙 Source</a>`
      : "";
  ...
  sec.innerHTML = `
    ...
    <div class="proj-filter" id="projFilter">
      ...
      ${[...new Set(DATA.PROJECTS.map((p) => p.category))]
        .map((c) => `<button class="pf-btn" data-filter="${c}">${c}</button>`)
        .join("")}
    </div>
  ...
  $id("projFilter").addEventListener("click", (e) => {
    ...
    document.querySelectorAll(".pcard").forEach((card) => {
      const match =
        filter === "all" ||
        card.querySelector(".pcard-category")?.textContent === filter;
